...
{
	// Make mono (choose the greater of the two levels)
    newValue = Engine.getMasterPeakLevel(0) > Engine.getMasterPeakLevel(1) ? Engine.getMasterPeakLevel(0) : Engine.getMasterPeakLevel(1);
    
    // If higher than previous reading, take the new level, else decay the older one
